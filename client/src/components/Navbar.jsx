    ...
    <nav className="border-b border-gray-200 bg-white shadow-lg">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
        ...
        <Link to="/dashboard" className="flex items-center space-x-3">
          ...
          <span className="text-2xl font-bold text-gray-900 transition-colors hover:text-blue-600">
            DevConnect
          </span>
        </Link>
        ...
        <div className="flex items-center space-x-6">
          <Link
            to="/dashboard"
            className="flex items-center gap-1 font-medium text-gray-700 transition-colors hover:text-blue-600"
          >
