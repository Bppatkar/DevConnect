...
function Auth({ onLogin, buttonGradientStyle }) { 
  ...
  return (
    <div className="mx-auto max-w-md rounded-lg bg-gray-900/70 p-6 backdrop-blur-sm border border-gray-700">
      {/* Toggle Buttons */}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full rounded-lg px-4 py-2 font-semibold text-white disabled:bg-gray-600"
          style={buttonGradientStyle} // Apply gradient to submit button
        >
